...
- MP REGENERATION: MP recovers automatically at +1 per hour passively (handled by the client). Sleep recovers MP faster — a full night's sleep restores all MP. The GM can also set mp directly in stateChanges for meditation, magical events, or potions.
- HP REGENERATION: HP does NOT regenerate passively. HP recovers only through: rest (+2-5 HP for a full night's sleep via stateChanges hp field), healing spells, potions, or medical treatment. The GM should set the hp value in stateChanges when healing occurs.
